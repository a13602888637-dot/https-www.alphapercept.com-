...
export const EXACT_SEAT_ALIASES: Record<string, SeatAlias> = {
  ...
  "国泰海通证券股份有限公司上海长宁区江苏路证券营业部": { label: "章盟主观察席", category: "known-seat", confidence: "B" },
  ...
  "中信证券股份有限公司上海古北路证券营业部": { label: "上海古北路活跃席", category: "known-seat", confidence: "A" },
  ...
  "光大证券股份有限公司佛山季华六路证券营业部": { label: "佛山系观察席", category: "known-seat", confidence: "C" },
  "湘财证券股份有限公司佛山祖庙路证券营业部": { label: "佛山系观察席", category: "known-seat", confidence: "C" },
  "华鑫证券有限责任公司上海红宝石路证券营业部": { label: "炒股养家观察席", category: "known-seat", confidence: "B" },
  "华鑫证券股份有限公司上海红宝石路证券营业部": { label: "炒股养家观察席", category: "known-seat", confidence: "B" },
  "华鑫证券有限责任公司上海宛平南路证券营业部": { label: "炒股养家观察席", category: "known-seat", confidence: "B" },
  "华鑫证券股份有限公司上海宛平南路证券营业部": { label: "炒股养家观察席", category: "known-seat", confidence: "B" },
  ...
  "安信证券股份有限公司西安曲江池南路证券营业部": { label: "方新侠观察席", category: "known-seat", confidence: "B" },
  "国投证券股份有限公司西安曲江池南路证券营业部": { label: "方新侠观察席", category: "known-seat", confidence: "B" },
  ...
  "中国中金财富证券有限公司南京太平南路证券营业部": { label: "小鳄鱼观察席", category: "known-seat", confidence: "B" },
  "中金财富证券有限公司南京太平南路证券营业部": { label: "小鳄鱼观察席", category: "known-seat", confidence: "B" },
  "华泰证券股份有限公司天津东丽开发区二纬路证券营业部": { label: "天津东丽观察席", category: "known-seat", confidence: "C" },
  ...
  "国泰海通证券股份有限公司北京知春路证券营业部": { label: "北京知春路活跃席", category: "known-seat", confidence: "A" },
  "海通证券股份有限公司北京知春路证券营业部": { label: "北京知春路活跃席", category: "known-seat", confidence: "A" },
  "中信建投证券股份有限公司北京知春路证券营业部": { label: "中信建投北京知春路活跃席", category: "known-seat", confidence: "A" },
  "东方财富证券股份有限公司拉萨金融城南环路证券营业部": { label: "拉萨天团（散户集合席）", category: "known-seat", confidence: "A" },
  "东方财富证券股份有限公司拉萨团结路第一证券营业部": { label: "拉萨天团（散户集合席）", category: "known-seat", confidence: "A" },
  "东方财富证券股份有限公司拉萨团结路第二证券营业部": { label: "拉萨天团（散户集合席）", category: "known-seat", confidence: "A" },
  "东方财富证券股份有限公司拉萨东环路第一证券营业部": { label: "拉萨天团（散户集合席）", category: "known-seat", confidence: "A" },
  "东方财富证券股份有限公司拉萨东环路第二证券营业部": { label: "拉萨天团（散户集合席）", category: "known-seat", confidence: "A" },
};
