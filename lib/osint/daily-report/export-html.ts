...
export function buildDailyReportHtml(
  ...
  :root{color-scheme:light}*{box-sizing:border-box}body{margin:0;background:#f4f7fa;color:#17202c;font:16px/1.6 -apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC",sans-serif}main{max-width:980px;margin:0 auto;padding:24px;position:relative;z-index:1}header,section{background:#fff;border:1px solid #dce3eb;border-radius:12px;padding:20px;margin-bottom:16px}h1{font-size:24px;margin:0 0 6px}h2{font-size:19px;margin:0 0 8px}h3{font-size:16px;margin:6px 0}p{margin:4px 0}.meta,.section-meta,.source,.disclaimer{color:#667386;font-size:13px}.advice{padding:12px;border-left:4px solid #d99b22;background:#fff8e8;margin:12px 0}.table-wrap{overflow-x:auto}table{width:100%;border-collapse:collapse;min-width:620px}th,td{padding:10px 8px;border-bottom:1px solid #e6ebf0;text-align:left;vertical-align:top}th{color:#667386;font-size:13px}td small{display:block;color:#7a8798}.up{color:#c43f3f}.down{color:#138454}.muted{color:#7a8798}.badge,.tags span{display:inline-block;border:1px solid #ced7e2;border-radius:999px;padding:1px 7px;color:#526174;font-size:12px}.card{border-top:1px solid #e6ebf0;padding:14px 0}.card-head{display:flex;justify-content:space-between;color:#667386;font-size:12px}.seat-card ul{list-style:none;margin:8px 0 0;padding:0}.seat-card li{display:grid;grid-template-columns:1fr auto;gap:8px;padding:5px 0;border-top:1px solid #eef2f6}.seat-card li span{font-size:12px;color:#667386}.tags{display:flex;flex-wrap:wrap;gap:6px;margin-top:8px}.source a{color:#126b78}.empty{color:#7a8798}.watermark{position:fixed;inset:45% auto auto 50%;z-index:0;transform:translate(-50%,-50%) rotate(-24deg);font-size:42px;font-weight:700;letter-spacing:5px;color:rgba(34,67,84,.06);white-space:nowrap;pointer-events:none}.report-disclaimer{margin-top:20px;padding:14px;border-top:1px solid #dce3eb;color:#667386;font-size:13px}.print-footer{display:none}@media(max-width:640px){main{padding:12px}header,section{border-radius:8px;padding:16px}h1{font-size:21px}body{font-size:16px}.seat-card li{grid-template-columns:1fr}.watermark{font-size:26px}}@media print{body{background:#fff;font-size:11pt}main{max-width:none;padding:0 0 15mm}header,section{border:0;border-radius:0;padding:0;margin:0 0 14mm;break-inside:avoid}.card{break-inside:avoid}a{color:inherit;text-decoration:none}.watermark{position:fixed;inset:45% auto auto 50%;display:block;color:rgba(34,67,84,.08)}.print-footer{display:block;position:fixed;left:13mm;right:13mm;bottom:4mm;border-top:1px solid #ccd5df;padding-top:2mm;color:#667386;font-size:8pt}.report-disclaimer{break-inside:avoid}@page{size:A4;margin:13mm 13mm 22mm}}
