...
interface IntelligenceFeedListProps {
  feeds: IntelligenceFeedItem[]
  isLoading?: boolean
  onRefresh?: () => void
}

export function IntelligenceFeedList({ feeds, isLoading = false, onRefresh }: IntelligenceFeedListProps) {
